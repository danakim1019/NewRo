...
void Mesh::RenderModel(glm::mat4& model, glm::mat4& view, glm::mat4& projection, glm::mat4& location, glm::vec3 camPosition, glm::vec3 lightPosition,std::string shaderType,glm::vec3 DiffuseColor) {
	...
	if (shaderType == "modelTexture") {
		...
		glUniform4fv(shaderProgram->uniform("viewPosition"), 1, glm::value_ptr(glm::vec4(camPosition,1.0)));
		...
		glUniform3fv(shaderProgram->uniform("Material.Ka"), 1, glm::value_ptr(DiffuseColor));
		glUniform3fv(shaderProgram->uniform("Material.Kd"), 1, glm::value_ptr(DiffuseColor));
		glUniform3fv(shaderProgram->uniform("Material.Ks"), 1, glm::value_ptr(DiffuseColor));
		glUniform1fv(shaderProgram->uniform("Material.Shiness"), 1, &shininess);
